...
class LanguageConverter
{
    ...
    private $charMap = array(
		'geolat2utf8' => array('a' => 'ა', 'b' => 'ბ', 'g' => 'გ', 'd' => 'დ', 'e' => 'ე', 'v' => 'ვ', 'z' => 'ზ', 'T' => 'თ', 'i' => 'ი', 'k' => 'კ', 'l' => 'ლ', 'm' => 'მ', 'n' => 'ნ', 'o' => 'ო', 'p' => 'პ', 'J' => 'ჟ', 'r' => 'რ', 's' => 'ს', 't' => 'ტ', 'u' => 'უ', 'f' => 'ფ', 'q' => 'ქ', 'R' => 'ღ', 'y' => 'ყ', 'S' => 'შ', 'C' => 'ჩ', 'c' => 'ც', 'Z' => 'ძ', 'w' => 'წ', 'W' => 'ჭ', 'x' => 'ხ', 'j' => 'ჯ', 'h' => 'ჰ'), 
		...
		'infobuk2utf8'=>array('‹'=>'ა', 'Œ'=>'ბ', '•'=>'გ', '–'=>'დ', '—'=>'ე', '˜'=>'ვ', 'š'=>'ზ', '›'=>'თ', 'œ'=>'ი', 'Ÿ'=>'კ', '¡'=>'ლ', '¢'=>'მ', '£'=>'ნ', '¤'=>'ო', '¥'=>'პ', '¦'=>'ჟ', 'ª'=>'რ', '«'=>'ს', '¬'=>'ტ', '­'=>'უ', '¯'=>'ფ', '°'=>'ქ', '±'=>'ღ', '²'=>'ყ', '³'=>'შ', '´'=>'ჩ', 'µ'=>'ც', 'º'=>'ძ', '»'=>'წ', '¼'=>'ჭ', '½'=>'ხ', '¾'=>'ჯ', '¿'=>'ჰ')
		);
            ...
            if (!isset($this->charMapByIndex[$charMapKeyIndex])) {
                if (!is_null($charMapLayout) && $charMapLayout !== '') {
                    $this->charMapByIndex = array(
                        $charMapKeyIndex => array(
                            $charMapLayout => $charMapValues
                        )
                    );
                }
            } else {
